...
.. |Travis CI result stable1.x| image:: https://travis-ci.com/manga-py/manga-py.svg?branch=stable_1.x
   ...
   :alt: Latest push
.. |Travis CI result| image:: https://travis-ci.com/manga-py/manga-py.svg?branch=1.29.3
   :target: https://travis-ci.com/manga-py/manga-py/branches
   :alt: Latest tag
...
.. |PyPI - Downloads| image:: https://img.shields.io/pypi/dm/manga-py
   :alt: PyPI - Downloads
.. |PyPI - size| image:: https://img.shields.io/badge/dynamic/json?label=PyPI%20size&query=%24.size&url=https%3A%2F%2Fpip.sttv.me%2Fmanga-py.json%3Fhuman-size%3Dtrue%26index%3D0%26version%3D1.29.3
   :alt: PyPI - size
