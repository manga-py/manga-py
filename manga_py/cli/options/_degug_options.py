...
def debug_options(args_parser: ArgumentParser):  # pragma: no cover
    ...
    args.add_argument('--simulate', action='store_true',
                      help='Simulate running %(prog)s, where: 1) do not download'
                           ' files and, 2) do not write anything on disk.')

    args.add_argument('--info', action='store_true', help='Show current processing chapter info.')
