...
def _image_args(args_parser):  # pragma: no cover
    ...
    args.add_argument('--not-change-files-extension', action='store_const', const=True, default=False,
...
def _downloading_args(args_parser):  # pragma: no cover
    ...
    args.add_argument('--reverse-downloading', action='store_const', const=True, default=False,
    ...
    args.add_argument('--rewrite-exists-archives', action='store_const', const=True, default=False,
